...
namespace Assignment2.Pages.IMP
{
    public class DepartmentsController : Controller
    {
        private readonly Assignment2Context _context;

        public DepartmentsController(Assignment2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Department != null ? 
                          ...
                          Problem("Entity set 'Assignment2Context.Department'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Assignment2Context.Department'  is null.");
            }
            var department = await _context.Department.FindAsync(id);
            if (department != null)
            {
